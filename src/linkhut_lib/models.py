...
class Bookmark(BaseModel):
    ...
    url: HttpUrl = Field(..., description="The URL of the bookmark", frozen=True, alias="href")
...
class HTMLResponse(BaseModel):
    ...
    content: BeautifulSoup = Field(..., description="Parsed HTML content")
...
class APIResponse(BaseModel):
    ...
    content: dict[str, Any] | list[dict[str, Any]] = Field(
